...
const Footer = () => {
  return (
    <footer className="bg-foreground text-background/90 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="col-span-full md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-background/80 text-sm">
            &copy; {new Date().getFullYear()} TripWripp. All rights reserved.
          </p>
        </div>
        ...
        <div className="col-span-full md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="space-y-2 text-background/90 text-sm">
